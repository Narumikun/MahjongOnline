...
describe('connection', function () {
  ...
  it('should connect to a namespace after db established', function (done) {
  ...
  it('should open a new namespace after db gets closed', function (done) {
    var manager = io.Manager();
    var socket = manager.socket('/');
    socket.on('connect', function () {
      socket.disconnect();
  ...
  it('should not try to reconnect and should form a db when connecting to correct port with default timeout', function (done) {
  ...
  // Ignore incorrect db test for old IE due to no support for
